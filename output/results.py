...
def save_unfiltered_detections(out_dir, detect):
    ...
    # unified_detection upscales BOTH kept and dropped track stacks
    # to detect["labels"].shape so all of tracks_raw shares the
    # original resolution. We can safely use that shape.
