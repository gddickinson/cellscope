...
**Started**: 2026-05-22T23:32:09
**Finished**: 2026-05-22T23:32:09
**Runtime**: 6269 s
**Pipeline**: `hybrid_cpsam_multi` (mode = multi)

## Source recording

- **video_path**: `/Users/george/claude_test/cellscope/data/ic295_gt_full/Pos44_OT/IC295__1_MMStack_Pos44-OT.ome.tif`
- **n_frames**: 97
- **has Cy5 channel**: True
- **um_per_px**: 0.6523
- **time_interval_min**: 10.0
- **checksum**: `sha256-64mb:8f0b9f0b0d9e3481`

## Results

- **n_tracks**: 7
- **n_cy5_fusion_added** (pre-tracking): 10
- **n_analysis_cells**: 0
  - fusion source breakdown: both = 6, cy5_only = 1
...
```bash
conda run -n cellpose4 python scripts/run_pipeline_on_gt_recording.py data/ic295_gt_full/Pos44_OT
```

## Output directory

`/Users/george/claude_test/cellscope/data/ic295_gt_full/Pos44_OT/pipeline_results`
