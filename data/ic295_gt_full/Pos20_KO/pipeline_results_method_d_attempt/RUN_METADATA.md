...
**Started**: 2026-05-22T14:14:31
**Finished**: 2026-05-22T14:14:31
**Runtime**: 5988 s
**Pipeline**: `hybrid_cpsam_multi` (mode = multi)

## Source recording

- **video_path**: `/Users/george/claude_test/cellscope/data/ic295_gt_full/Pos20_KO/IC295__1_MMStack_Pos20-KO.ome.tif`
- **n_frames**: 97
- **has Cy5 channel**: True
- **um_per_px**: 0.6523
- **time_interval_min**: 10.0
- **checksum**: `sha256-64mb:7fb568755b09cd3d`

## Results

- **n_tracks**: 12
- **n_cy5_fusion_added** (pre-tracking): 30
- **n_analysis_cells**: 0
  - fusion source breakdown: both = 10, dic_only = 2
...
- **git commit**: `d340c37ef047`
- **rerun command**:

```bash
conda run -n cellpose4 python scripts/run_pipeline_on_gt_recording.py data/ic295_gt_full/Pos20_KO
```

## Output directory

`/Users/george/claude_test/cellscope/data/ic295_gt_full/Pos20_KO/pipeline_results`
