...
**Recording**: `/Users/george/cellscope/data/ic295_gt_full/Pos39_OT`
...
|---:|---:|---:|---:|---:|---:|
| IoU≥0.3 | 7.0 | 0.4 | 0.1 | 0.97 | 0.97 |
| IoU≥0.5 | 7.0 | 0.4 | 0.1 | 0.97 | 0.97 |
| IoU≥0.7 | 6.9 | 0.5 | 0.2 | 0.95 | 0.96 |

- **Mean per-cell IoU (matched)**: 0.859
- **Median per-cell IoU (matched)**: 0.864
- **Out-of-scope predictions/frame**: 0.1
...
- **Mean ID consistency** (per GT cell, fraction of frames where it
  maps to the same pipeline ID): **90.00%**
